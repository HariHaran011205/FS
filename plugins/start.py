...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="First Channel 🙂", url=client.invitelink),
            InlineKeyboardButton(text="Second Channel 😏", url=client.invitelink2),
        ],
        [
            InlineKeyboardButton(text="Third Channel 😂", url=client.invitelink3),
            InlineKeyboardButton(text="Forth Channel 😊", url=client.invitelink4),
        ]
    ]
    try:
        buttons.append(
